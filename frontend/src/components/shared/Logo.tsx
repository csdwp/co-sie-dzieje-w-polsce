...
const Logo = () => {
  ...
  return (
    ...
    >
      ...
      <span
        className={`w-max relative top-0.5 font-libre text-[14px] font-normal tracking-[0.15em] dark:text-neutral-200 text-neutral-800 transition-all duration-700 ease-out ${
